...
import ButtonBase from "@mui/material/ButtonBase"; // Optional: Replace with plain 'button' if preferred
...
export interface ButtonProps
  ...
  asChild?: boolean; // Optional — retained for compatibility
}

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    const Comp = "button"; // No more Slot — just render button directly
    return (
      <ButtonBase
